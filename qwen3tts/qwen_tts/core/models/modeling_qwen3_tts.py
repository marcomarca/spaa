...
# Try to import from transformers, fall back to compat layer
try:
    from transformers.integrations import use_kernel_forward_from_hub
except ImportError:
    from ...compat import use_kernel_forward_from_hub
...
try:
    ...
    from ...compat import create_causal_mask, create_sliding_window_causal_mask

try:
    from transformers.modeling_flash_attention_utils import FlashAttentionKwargs
except ImportError:
    FlashAttentionKwargs = dict  # Fallback to dict

try:
    from transformers.modeling_layers import GradientCheckpointingLayer
except ImportError:
    from ...compat import GradientCheckpointingLayer

try:
    from transformers.modeling_rope_utils import ROPE_INIT_FUNCTIONS, dynamic_rope_update
except ImportError:
    ROPE_INIT_FUNCTIONS = {}
    def dynamic_rope_update(config, device, seq_len, **kwargs):
        return None, None
...
try:
    ...
    try:
        ...
        try:
            ...
            # Fallback: create a no-op type that works with **kwargs
            class Unpack:
...
try:
    ...
    from ...compat import can_return_tuple

try:
    from transformers.utils.hub import cached_file
except ImportError:
    from huggingface_hub import cached_download as cached_file
